...
<html>
    ...
    <body>
        <p>
            <a href="${pageContext.request.contextPath}/customer/search">Filter Results</a>
        </p>
        <table>
            <tr>
                <th>Restaurant</th>
            ...
            <c:forEach items="${restaurants}" var="restaurant">
                <tr>
                    ...
                    <td>
                        <a href="${pageContext.request.contextPath}/customer/restaurantDetails?id=${restaurant.id}">View</a>
                    </td>   
                </tr>
            </c:forEach>
        </table>
